    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      ...
      <motion.div initial={{ scale: 0.96, y: 16 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.96, y: 16 }}
        ...
        <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
          <h3 className="font-bold text-base" style={{ color: "#16204D" }}>Set Rate</h3>
        ...
        <div className="px-6 pt-4 flex gap-3">
          ...
          <div className="min-w-0">
            <p className="font-semibold text-sm truncate" style={{ color: "#16204D" }}>{sub.title || "Untitled"}</p>
          ...
          <div className="flex gap-2 pt-1">
            ...
            {sub.status !== "paid" && (
              <button onClick={() => { onClose(); onSetRate(); }}
                ...
                style={{ background: sub.offeredAmount ? "#2B50F6" : "#16204D" }}>
...
export default function SocialsAdmin() {
  ...
  return (
    <div className="p-6 space-y-5 max-w-[1200px] mx-auto">
      <div>
        <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>Video Submissions</h2>
                  ...
                  <tr key={s._id}
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-semibold truncate max-w-[200px]" style={{ color: "#16204D" }}>{s.title || "Untitled"}</p>
                    ...
                    <td className="px-5 py-3.5 hidden lg:table-cell">
                      <p className="text-sm font-medium" style={{ color: "#16204D" }}>{s.collaborator?.name || "—"}</p>
                    ...
                    <td className="px-5 py-3.5 hidden md:table-cell">
                      <div className="flex items-center gap-1 text-sm font-medium" style={{ color: "#16204D" }}>
                      ...
                      <div className="flex items-center gap-1.5">
                        {s.status !== "paid" && (
                          <button onClick={() => setRatingModal(s)}
                            ...
                            style={{ background: s.offeredAmount ? "#EEF2FF" : "#16204D", color: s.offeredAmount ? "#2B50F6" : "#fff" }}>
