    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl p-6" style={{ border: "1px solid #E9EBF5" }}
        ...
        <div className="flex items-center justify-between mb-5">
          <h3 className="font-bold text-base" style={{ color: "#16204D" }}>Invite Social Creator</h3>
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl p-6" style={{ border: "1px solid #E9EBF5" }}
        ...
        <p className="text-sm text-slate-500 mb-5">
          Mark <strong className="text-emerald-700">${pendingPayout.toFixed(2)}</strong> as paid to <strong style={{ color: "#16204D" }}>{creator.name}</strong>?
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl w-full max-w-sm shadow-2xl p-6" style={{ border: "1px solid #E9EBF5" }}
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-bold text-sm" style={{ color: "#16204D" }}>Remove Creator</h3>
            <p className="text-xs text-slate-400">{creator.name}</p>
          </div>
        </div>
        <p className="text-sm text-slate-500 mb-5">
          This permanently removes <strong style={{ color: "#16204D" }}>{creator.name}</strong> from the social creator portal.
...
function FeaturedYouTubersPanel() {
  ...
  return <section className="bg-white rounded-xl p-5" style={{ border: "1px solid #E9EBF5" }}>
    <div className="flex items-center gap-2"><Video className="w-4 h-4 text-red-500" /><div><h3 className="font-bold text-sm" style={{ color: "#16204D" }}>YouTubers That Trust Us</h3><p className="text-xs text-slate-500 mt-0.5">Adding a channel here automatically publishes it to the homepage carousel.</p></div></div>
  ...
  return (
    <div className="p-6 space-y-5 max-w-[1200px] mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>Social Creators</h2>
                ...
                return (
                  <tr key={c._id}
                    ...
                    <td className="px-5 py-4">
                      <p className="text-sm font-semibold" style={{ color: "#16204D" }}>{c.name}</p>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-sm font-semibold" style={{ color: "#16204D" }}>{s.total ?? 0}</span>
