          ...
          >
            {[
              ...
              <div key={i} className="text-center">
                <div className="text-xl sm:text-2xl font-extrabold text-white" style={{ fontFamily: "var(--font-display, inherit)" }}>{stat.value}</div>
                <div className="text-xs sm:text-sm mt-0.5" style={{ color: "rgba(165,180,252,0.68)" }}>{stat.label}</div>
              </div>
            ))}
          </motion.div>
        </div>
