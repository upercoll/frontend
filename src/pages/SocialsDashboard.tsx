...
const STATUS_CFG: Record<string, { label: string; color: string; bg: string }> = {
  active:    { label: "Tracking",   color: "#B9C6FF", bg: "rgba(129,140,248,0.15)" },
                    ...
                    <div key={s._id} className="flex items-start gap-4 px-5 py-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          ...
                          {s.adminNote && (
                            <span className="text-[10px] px-2 py-0.5 rounded-md" style={{ background: "rgba(43,80,246,0.12)", color: "#B9C6FF" }}>
                              Note: {s.adminNote}
                            </span>
                          )}
                          <a href={s.url} target="_blank" rel="noopener noreferrer"
                            className="flex items-center gap-1 text-[10px] ml-auto"
                            style={{ color: "rgba(43,80,246,0.7)" }}>
