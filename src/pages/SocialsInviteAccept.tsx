...
export default function SocialsInviteAccept() {
  const [, params] = useRoute("/socials/invite/:token");
  ...
  const handleActivate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("social_token", res.token);
      setStep("done");
      setTimeout(() => navigate("/socials/dashboard"), 1500);
    } catch (err: any) {
      setErrorMsg(err.message);
    } finally {
      setLoading(false);
    ...
    <div className="min-h-screen flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.4)" }}>Creator Invitation</p>
        </div>
        ...
        <div className="rounded-2xl p-8" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", backdropFilter: "blur(20px)" }}>
          ...
          {step === "done" && (
            <div className="text-center py-4">
              ...
              <p className="text-sm" style={{ color: "rgba(255,255,255,0.5)" }}>Redirecting to your creator dashboard...</p>
            </div>
          )}
            ...
            <form onSubmit={handleActivate} className="space-y-5">
              <div className="text-center mb-6">
                ...
                <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.5)" }}>
                  You've been invited as a content creator. Set up your account to get started.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button type="button" onClick={sendCode} disabled={loading || codeSent}
                    ...
                    style={{ background: codeSent ? "rgba(74,222,128,0.15)" : "rgba(124,58,237,0.3)", border: "1px solid rgba(124,58,237,0.4)", color: codeSent ? "#4ade80" : "#C7D4FF" }}>
