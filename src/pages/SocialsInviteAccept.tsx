...
export default function SocialsInviteAccept() {
  ...
  return (
    <StaffInviteLayout portalName="Creator Invitation" description="You've been invited to create content with RBstars." step={stepLabel}>
      {step === "loading" && (
      ...
      {step === "done" && (
        <motion.div key="done" className="text-center py-4">
          ...
          <p className="text-sm" style={{ color: "#9BAEBB" }}>Redirecting to your creator dashboard...</p>
        </motion.div>
      )}
