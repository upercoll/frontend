...
function AuthInput({
  ...
  return (
    <div className="space-y-1.5">
      <label className="block text-[11px] font-bold uppercase tracking-widest" style={{ color: "#93A8FF" }}>
        {label}
      </label>
      <div
        ...
        style={{
          ...
          border: `1.5px solid ${error ? "rgba(248,113,113,0.5)" : focused ? "#2B50F6" : "rgba(185,198,255,0.18)"}`,
          boxShadow: focused ? `0 0 0 3px ${error ? "rgba(248,113,113,0.08)" : "rgba(43,80,246,0.1)"}` : "none",
        }}
      >
        {icon && <span style={{ color: focused ? "#B9C6FF" : "#2B50F6", flexShrink: 0 }}>{icon}</span>}
        <input
          type={type}
    ...
    <div className="flex gap-2 justify-center">
      {Array.from({ length: 6 }).map((_, i) => (
        <motion.input
          ...
          style={{
            background: value[i] ? "rgba(43,80,246,0.25)" : "rgba(255,255,255,0.05)",
            border: `2px solid ${value[i] ? "#2B50F6" : "rgba(185,198,255,0.18)"}`,
            boxShadow: value[i] ? "0 0 12px rgba(43,80,246,0.3)" : "none",
          }}
        />
      ))}
    </div>
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          style={{
            background: "linear-gradient(180deg,#0E1A3C 0%,#0B1437 100%)",
            border: "1.5px solid rgba(43,80,246,0.25)",
            boxShadow: "0 32px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(185,198,255,0.05)",
          }}
        >
          {}
          <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full pointer-events-none"
            style={{ background: "radial-gradient(circle,rgba(43,80,246,0.18),transparent 70%)" }} />
              ...
              <div className="flex items-center gap-2.5">
                {displayStep === "verify" && (
                  <button onClick={() => { setStep("register"); setVerifyCode(""); clearErrors(); }}
                    ...
                    style={{ background: "rgba(255,255,255,0.05)", color: "#93A8FF" }}>
                    <ArrowLeft size={15} />
                  </button>
                )}
            ...
            <AnimatePresence mode="wait">
              {displayStep === "login" && (
                ...
                >
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02, boxShadow: "0 0 28px rgba(43,80,246,0.45)" }}
                    whileTap={{ scale: 0.97 }}
                    onClick={handleLogin}
                    disabled={loading}
                    className="w-full py-3.5 rounded-xl font-extrabold text-white flex items-center justify-center gap-2"
                    style={{ background: "linear-gradient(135deg,#2B50F6,#1D3BD1)", opacity: loading ? 0.7 : 1 }}>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 flex items-center gap-2.5 px-3.5 py-3 rounded-xl transition-all duration-200"
                        style={{
                          background: "rgba(255,255,255,0.05)",
                          border: `1.5px solid ${fieldErrors.robloxUsername ? "rgba(248,113,113,0.5)" : robloxAvatar ? "rgba(43,80,246,0.6)" : "rgba(185,198,255,0.18)"}`,
                        }}>
                        <Gamepad2 size={15} color="#2B50F6" className="flex-shrink-0" />
                        <input
                          type="text"
                          ...
                          className="flex-1 bg-transparent outline-none text-sm font-medium text-white placeholder:text-[#475569] min-w-0"
                        />
                        {avatarLoading && <Loader2 size={13} className="animate-spin flex-shrink-0" style={{ color: "#2B50F6" }} />}
                      ...
                      <AnimatePresence>
                        {(robloxAvatar || avatarLoading) && (
                          <motion.div
                            ...
                            style={{ background: "rgba(43,80,246,0.15)", border: "2px solid rgba(43,80,246,0.4)" }}>
                            {avatarLoading
                              ? <Loader2 size={16} className="animate-spin" style={{ color: "#2B50F6" }} />
              ...
              {displayStep === "verify" && (
                ...
                >
                  <div className="text-center py-2">
                    <motion.div
                      animate={{ scale: [1, 1.06, 1], boxShadow: ["0 0 0px rgba(43,80,246,0)", "0 0 24px rgba(43,80,246,0.5)", "0 0 0px rgba(43,80,246,0)"] }}
                      transition={{ repeat: Infinity, duration: 2.4 }}
                      className="w-16 h-16 rounded-2xl mx-auto mb-3 flex items-center justify-center"
                      style={{ background: "linear-gradient(135deg,rgba(43,80,246,0.25),rgba(55,48,163,0.15))", border: "1.5px solid rgba(43,80,246,0.4)" }}>
                      <ShieldCheck size={28} color="#B9C6FF" />
                    </motion.div>
                    <p className="text-sm" style={{ color: "#93A8FF" }}>
                  ...
                  <motion.button
                    ...
                    className="w-full py-3.5 rounded-xl font-extrabold text-white flex items-center justify-center gap-2"
                    style={{
                      background: "linear-gradient(135deg,#2B50F6,#1D3BD1)",
                  ...
                  <div className="text-center">
                    <button
                      ...
                      style={{ color: resendCooldown > 0 ? "#475569" : "#B9C6FF" }}>
                      <RefreshCw size={11} />
