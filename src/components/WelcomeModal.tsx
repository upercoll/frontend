      ...
      {open && (
        ...
        >
          <motion.div
            ...
            style={{
              background: "#131C23",
              border: "1.5px solid rgba(59,167,255,0.18)",
            }}
          >
            {/* Close button */}
            <button
              ...
              style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(59,167,255,0.2)" }}
            >
              <X size={15} color="#3BA7FF" />
            </button>
            ...
            <div className="px-7 pt-4 pb-2 text-center">
              ...
              <p className="text-sm mb-1" style={{ color: "#3BA7FF" }}>
                How would you like to proceed?
              </p>
            </div>

            {/* Divider */}
            <div className="mx-7 my-2" style={{ height: "1px", background: "rgba(59,167,255,0.12)" }} />
            ...
            <div className="flex flex-col gap-3 px-7 pb-7 pt-3">
              ...
              <motion.button
                ...
                style={{
                  ...
                  border: "1.5px solid rgba(59,167,255,0.22)",
                  color: "#fff",
                }}
              >
                <span
                  className="flex items-center justify-center rounded-xl p-2 shrink-0"
                  style={{ background: "rgba(59,167,255,0.12)" }}
                >
                  <ShoppingBag size={16} color="#3BA7FF" />
                </span>
                <span>
                  <span className="block text-[15px] font-bold leading-tight">View Live Stock</span>
                  <span className="block text-xs font-normal mt-0.5" style={{ color: "rgba(59,167,255,0.75)" }}>
