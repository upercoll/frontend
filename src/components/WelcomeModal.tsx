      ...
      {open && (
        ...
        >
          <motion.div
            ...
            style={{
              background: "linear-gradient(160deg, #16204D 0%, #0E1A3C 100%)",
              border: "1.5px solid rgba(185,198,255,0.18)",
            }}
          >
            {/* Close button */}
            <button
              ...
              style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(185,198,255,0.2)" }}
            >
              <X size={15} color="#B9C6FF" />
            </button>
            ...
            <div className="px-7 pt-4 pb-2 text-center">
              ...
              >
                ...
                <span
                  style={{
                    background: "linear-gradient(90deg, #93A8FF, #C7D4FF)",
              ...
              <p className="text-sm mb-1" style={{ color: "#B9C6FF" }}>
                How would you like to proceed?
              </p>
            </div>

            {/* Divider */}
            <div className="mx-7 my-2" style={{ height: "1px", background: "rgba(185,198,255,0.12)" }} />
            ...
            <div className="flex flex-col gap-3 px-7 pb-7 pt-3">
              ...
              <motion.button
                ...
                style={{
                  background: "linear-gradient(90deg, #2B50F6, #7C3AED)",
                  color: "#fff",
                  boxShadow: "0 4px 20px rgba(43,80,246,0.35)",
                }}
              >
                <span
              ...
              <motion.button
                ...
                style={{
                  ...
                  border: "1.5px solid rgba(185,198,255,0.22)",
                  color: "#fff",
                }}
              >
                <span
                  className="flex items-center justify-center rounded-xl p-2 shrink-0"
                  style={{ background: "rgba(185,198,255,0.12)" }}
                >
                  <ShoppingBag size={16} color="#B9C6FF" />
                </span>
                <span>
                  <span className="block text-[15px] font-bold leading-tight">View Live Stock</span>
                  <span className="block text-xs font-normal mt-0.5" style={{ color: "rgba(185,198,255,0.75)" }}>
