...
interface StaffInviteLayoutProps {
  portalName: string;
  description: string;
  step: string;
...
export default function StaffInviteLayout({ portalName, description, step, children }: StaffInviteLayoutProps) {
  return (
        ...
        <div className="flex-1 flex flex-col justify-center px-4 sm:px-12 py-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="mb-6 text-center sm:text-left">
              ...
              <p className="text-sm" style={{ color: "#637784" }}>{step}</p>
            </div>
