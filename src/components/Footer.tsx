      ...
      <div className="px-6 sm:px-10 lg:px-16 py-14 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-xs font-semibold uppercase tracking-widest mb-3" style={{ color: "#637784" }}>Follow Us</p>
            <div className="flex items-center gap-2.5">
              {socials.map(({ Component, label }) => (
                <motion.a
                  ...
                  href="#"
                  aria-label={label}
                  whileHover={{ scale: 1.1, backgroundColor: "rgba(59,167,255,0.15)" }}
                  whileTap={{ scale: 0.93 }}
