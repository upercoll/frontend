  ...
  return (
    <div className="p-6 space-y-5 max-w-[1400px] mx-auto">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>Orders</h2>
        ...
        <button
          ...
          style={{ background: "#2B50F6", color: "#fff" }}
            ...
            {selected.size > 0 && (
              <div className="relative">
                <button
                  ...
                  style={{ background: "#16204D", color: "#fff" }}
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5">
                        <span className="text-sm font-mono font-semibold" style={{ color: "#2B50F6" }}>{order.orderNumber}</span>
                      </td>
                      <td className="px-4 py-3.5">
                        <p className="text-sm font-medium" style={{ color: "#16204D" }}>{order.customer.robloxUsername}</p>
                      ...
                      <td className="px-4 py-3.5">
                        <span className="text-sm font-semibold" style={{ color: "#16204D" }}>${order.pricing.total.toFixed(2)}</span>
                      </td>
                      <td className="px-4 py-3.5">
