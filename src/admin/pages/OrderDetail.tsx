...
const STATUS_STYLES: Record<string, { bg: string; text: string; border: string }> = {
  ...
  delivering:         { bg: "#EDE9FE", text: "#5B21B6", border: "#B9A6FF" },
  ...
  if (isLoading) {
    return (
      <div className="p-6 flex items-center justify-center py-20">
        <Loader2 className="w-6 h-6 animate-spin" style={{ color: "#2B50F6" }} />
      </div>
    );
  }
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <h2 className="text-lg sm:text-xl font-bold" style={{ color: "#16204D" }}>
                #{order.orderNumber}
              </h2>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-white rounded-xl overflow-hidden" style={{ border: "1px solid #E9EBF5" }}>
            <div className="flex items-center justify-between px-5 py-3.5" style={{ borderBottom: "1px solid #F3F4F6" }}>
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold" style={{ color: "#16204D" }}>
                ...
                {(order.items || []).map((item, i) => (
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold truncate" style={{ color: "#16204D" }}>{item.productSnapshot.name}</p>
                      <p className="text-xs text-slate-400">{item.productSnapshot.game}</p>
                    </div>
                    <div className="text-right flex-shrink-0 text-sm" style={{ color: "#16204D" }}>
                      ${item.unitPrice.toFixed(2)} × {item.quantity}
                    </div>
                    <div className="text-right flex-shrink-0 font-bold text-sm w-20" style={{ color: "#16204D" }}>
          ...
          <div className="bg-white rounded-xl overflow-hidden" style={{ border: "1px solid #E9EBF5" }}>
            <div className="flex items-center gap-2 px-5 py-3.5" style={{ borderBottom: "1px solid #F3F4F6" }}>
              <CreditCard className="w-4 h-4" style={{ color: isPaid ? "#22C55E" : "#f59e0b" }} />
              <span className="text-sm font-semibold" style={{ color: "#16204D" }}>
                {isPaid ? "Paid" : "Unpaid"}
              </span>
            </div>
            <div className="p-5 space-y-2 text-sm">
              ...
              <div className="flex justify-between font-bold pt-2" style={{ color: "#16204D", borderTop: "1px solid #F3F4F6" }}>
                <span>Total</span>
          ...
          <div className="bg-white rounded-xl p-5" style={{ border: "1px solid #E9EBF5" }}>
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-sm" style={{ color: "#16204D" }}>Internal Notes</h3>
              <button onClick={() => { setAdminNotes(order.adminNotes || ""); setEditNotes(true); }}
                className="w-7 h-7 rounded-lg flex items-center justify-center"
                style={{ background: "#EEF2FF", color: "#2B50F6" }}>
            ...
            {editNotes ? (
              <div className="space-y-2">
                <textarea value={adminNotes} onChange={(e) => setAdminNotes(e.target.value)} rows={3}
                  ...
                  style={{ background: "#F7F8FC", border: "1px solid #E9EBF5", color: "#16204D" }} autoFocus />
          ...
          <div className="bg-white rounded-xl overflow-hidden" style={{ border: "1px solid #E9EBF5" }}>
            <div className="px-5 py-3.5" style={{ borderBottom: "1px solid #F3F4F6" }}>
              <h3 className="font-semibold text-sm" style={{ color: "#16204D" }}>Timeline</h3>
            </div>
            <div className="p-5">
              <div className="flex gap-3 mb-4">
                ...
                <div className="flex-1">
                  <textarea value={comment} onChange={e => setComment(e.target.value)} rows={2}
                    ...
                    className="w-full rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 resize-none"
                    style={{ background: "#F7F8FC", border: "1px solid #E9EBF5", color: "#16204D" }} />
              ...
              <div className="space-y-3 mt-2">
                {[...timeline].reverse().map((event, i) => (
                  <div key={i} className="flex gap-3 items-start">
                    <div className="w-2 h-2 rounded-full mt-2 flex-shrink-0" style={{ background: "#2B50F6" }} />
                    <div className="flex-1 min-w-0">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl p-4" style={{ border: "1px solid #E9EBF5" }}>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-sm font-semibold" style={{ color: "#16204D" }}>Notes</h3>
          ...
          <div className="bg-white rounded-xl p-4" style={{ border: "1px solid #E9EBF5" }}>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-semibold" style={{ color: "#16204D" }}>Order Status</h3>
          ...
          <div className="bg-white rounded-xl p-4" style={{ border: "1px solid #E9EBF5" }}>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-semibold" style={{ color: "#16204D" }}>Customer</h3>
            </div>
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-semibold" style={{ color: "#2B50F6" }}>{order.customer.robloxUsername}</p>
          ...
          {/* Conversion Summary */}
          <div className="bg-white rounded-xl p-4" style={{ border: "1px solid #E9EBF5" }}>
            <h3 className="text-sm font-semibold mb-3" style={{ color: "#16204D" }}>Conversion summary</h3>
          ...
          {/* Order Risk */}
          <div className="bg-white rounded-xl p-4" style={{ border: "1px solid #E9EBF5" }}>
            <h3 className="text-sm font-semibold mb-3" style={{ color: "#16204D" }}>Order risk</h3>
              ...
              {["low", "medium", "high"].map((level, i) => {
                ...
                return (
                  <div key={level} className="h-2 flex-1 rounded-full"
                    style={{ background: i <= activeIdx ? (i === 0 ? "#22C55E" : i === 1 ? "#f59e0b" : "#ef4444") : "#e5e7eb" }} />
                );
              })}
            </div>
          ...
          {/* Tags */}
          <div className="bg-white rounded-xl p-4" style={{ border: "1px solid #E9EBF5" }}>
            <h3 className="text-sm font-semibold mb-3" style={{ color: "#16204D" }}>Tags</h3>
            ...
            <div className="flex gap-2">
              ...
              <button onClick={handleAddTag}
                className="px-3 py-1.5 rounded-lg text-xs font-medium"
                style={{ background: "#16204D", color: "white" }}>
                Add
              </button>
            </div>
          </div>
          ...
          {claimSession && (
            <div className="bg-white rounded-xl p-4" style={{ border: "1px solid #E9EBF5" }}>
              <h3 className="text-sm font-semibold mb-3" style={{ color: "#16204D" }}>Claim Session</h3>
              <div className="space-y-2 text-xs">
                ...
                {claimSession.assignedAgent && (
                  <div className="flex justify-between">
                    ...
                    <span style={{ color: "#16204D" }}>{claimSession.assignedAgent.name}</span>
                  </div>
                )}
                <div className="flex justify-between">
                  <span className="text-slate-400">Messages</span>
                  <span style={{ color: "#16204D" }}>{claimSession.messages?.length || 0}</span>
                </div>
              </div>
            </div>
          )}
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.95, y: 20 }}
              ...
              <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
                <div>
                  <h3 className="font-bold text-lg" style={{ color: "#16204D" }}>Issue Refund</h3>
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <button onClick={() => setRefundAmount(order.pricing.total.toFixed(2))}
                      ...
                      style={{ background: "#EEF2FF", color: "#2B50F6" }}>Full</button>
        ...
        {showFulfill && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.95, y: 20 }}
              ...
              onClick={e => e.stopPropagation()}>
              <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
                <h3 className="font-bold text-lg" style={{ color: "#16204D" }}>Complete Order</h3>
