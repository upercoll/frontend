...
const inpStyle = { background: "#F7F8FC", border: "1px solid #E9EBF5", color: "#16204D" };
    ...
    <motion.div
      ...
      <motion.div
        ...
        <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
          <h3 className="font-bold text-lg" style={{ color: "#16204D" }}>Edit Stocker</h3>
    ...
    <motion.div
      ...
      <motion.div
        ...
        <div className="flex items-center justify-between px-6 py-4 flex-shrink-0" style={{ borderBottom: "1px solid #F3F4F6" }}>
          <div>
            <h3 className="font-bold text-lg" style={{ color: "#16204D" }}>Payouts — {stocker.name || stocker.email}</h3>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-5">
            ...
            {(payoutData as any)?.stocker?.cryptoAddress && (
              <div className="rounded-xl px-4 py-3 flex items-center gap-2" style={{ background: "#EEF2FF", border: "1px solid #C7D2FE" }}>
                <DollarSign className="w-4 h-4 flex-shrink-0" style={{ color: "#2B50F6" }} />
                <div className="text-sm">
                  <span className="font-medium" style={{ color: "#16204D" }}>Crypto: </span>
                  <span className="font-mono text-xs" style={{ color: "#2B50F6" }}>{(payoutData as any).stocker.cryptoAddress}</span>
                    ...
                    <tbody>
                      {unpaidDeliveries.map((d: any, i: number) => (
                        <tr key={i} style={{ borderBottom: "1px solid #F3F4F6" }}
                          ...
                          <td className="px-3 py-2.5 font-medium" style={{ color: "#16204D" }}>{d.robloxUsername}</td>
                  ...
                  {payouts.map((p: any) => (
                    <div key={p._id} className="flex items-center justify-between px-4 py-3 rounded-xl text-sm"
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-semibold" style={{ color: "#16204D" }}>${p.amount.toFixed(2)}</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                <p className="font-semibold text-sm" style={{ color: "#16204D" }}>
            ...
            <div className="hidden md:flex items-center gap-4 flex-shrink-0 text-center">
              <div>
                <p className="text-xs font-bold" style={{ color: "#16204D" }}>{stocker.stockedCount ?? 0}</p>
              ...
              <div>
                <p className="text-xs font-bold" style={{ color: "#16204D" }}>{stocker.commissionRate}%</p>
                  ...
                  {detailLoading ? (
                    ...
                    <>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {[
                          { label: "Total Requests", value: detail.stats.totalRequests, color: "#16204D" },
  ...
  return (
    <div className="p-6 space-y-5 max-w-[900px] mx-auto">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>Stocker Tracking</h2>
      ...
      {stockers.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { label: "Total Stockers", value: stockers.length, icon: Users, color: "#2B50F6" },
            { label: "Delivered-Sale Revenue", value: `$${stockers.reduce((s, t) => s + Number((t as any).totalRevenue || 0), 0).toFixed(2)}`, icon: TrendingUp, color: "#22C55E" },
            ...
            <div key={stat.label} className="bg-white rounded-2xl p-4 flex items-center gap-3" style={{ border: "1px solid #E9EBF5" }}>
              ...
              <div>
                <p className="text-lg font-bold" style={{ color: "#16204D" }}>{stat.value}</p>
        ...
        {showInvite && (
          <motion.div
            ...
            <motion.div
              ...
              onClick={e => e.stopPropagation()}>
              <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
                <h3 className="font-bold text-lg" style={{ color: "#16204D" }}>Invite Stocker</h3>
