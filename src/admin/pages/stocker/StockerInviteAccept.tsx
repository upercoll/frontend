      ...
      >
        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4"
            style={{ background: "linear-gradient(135deg,#2B50F6,#7C5CFF)", boxShadow: "0 0 32px rgba(43,80,246,0.4)" }}>
            <Archive className="w-7 h-7 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-white">Stocker Invitation</h1>
          <p className="text-sm mt-1" style={{ color: "rgba(185,198,255,0.7)" }}>
            ...
            <div className="space-y-5">
              <div className="text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium"
                  style={{ background: "rgba(43,80,246,0.15)", color: "#B9C6FF", border: "1px solid rgba(43,80,246,0.25)" }}>
