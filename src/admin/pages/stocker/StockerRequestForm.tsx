      ...
      <div className="flex flex-col items-center justify-center h-full py-20 space-y-4">
        ...
        <div className="flex gap-3">
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
            ...
            style={{ background: "rgba(43,80,246,0.8)", border: "1px solid rgba(43,80,246,0.4)" }}>
            Submit Another
          </motion.button>
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                ...
                return (
                  <motion.div key={product._id} whileHover={{ y: -2 }}
                    ...
                    style={{
                      ...
                      border: inCart ? "1.5px solid rgba(43,80,246,0.6)" : "1px solid rgba(255,255,255,0.08)",
                      boxShadow: inCart ? "0 0 0 3px rgba(43,80,246,0.1)" : "none",
                    }}
                      ...
                      <div className="flex items-center justify-between mt-1">
                        ...
                        {inCart ? (
                          <div className="flex items-center gap-1.5" onClick={e => e.stopPropagation()}>
                            ...
                            <span className="text-xs font-bold min-w-[16px] text-center" style={{ color: "#B9C6FF" }}>{cartItem.quantity}</span>
                            <button onClick={e => { e.stopPropagation(); addToCart(product); }}
                              className="w-5 h-5 rounded flex items-center justify-center"
                              style={{ background: "rgba(43,80,246,0.2)", color: "#B9C6FF" }}>
                              <Plus className="w-2.5 h-2.5" />
                            </button>
                          </div>
                        ) : (
                          <div className="w-5 h-5 rounded-full flex items-center justify-center"
                            style={{ background: "rgba(43,80,246,0.15)" }}>
                            <Plus className="w-2.5 h-2.5" style={{ color: "#B9C6FF" }} />
                          </div>
                        )}
                      </div>
                        ...
                        <motion.div key={c.product._id}
                          ...
                          <div className="flex items-center gap-2">
                            <div className="flex items-center gap-1.5 flex-1 rounded-lg px-2 py-1.5"
                              style={{
                                background: hasCustom ? "rgba(43,80,246,0.1)" : "rgba(255,255,255,0.05)",
                                border: `1px solid ${hasCustom ? "rgba(43,80,246,0.3)" : "rgba(255,255,255,0.08)"}`,
                              }}>
                              <Tag className="w-3 h-3 flex-shrink-0" style={{ color: hasCustom ? "#B9C6FF" : "rgba(255,255,255,0.3)" }} />
                              ...
                              <input
                                ...
                                style={{ color: hasCustom ? "#B9C6FF" : "white" }}
                              />
                            </div>
                          ...
                          <div className="flex justify-between text-[10px]" style={{ color: "rgba(255,255,255,0.35)" }}>
                            ...
                            <span className="font-semibold" style={{ color: hasCustom ? "#B9C6FF" : "#4ade80" }}>
