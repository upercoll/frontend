    ...
    <div className="max-w-[1000px] mx-auto space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}
        ...
        {[
          ...
          { label: "Commission Rate", value: `${stocker?.commissionRate || 0}%`, icon: TrendingUp, color: "#B9A6FF", sub: "per delivery" },
      ...
      {stocker?.cryptoAddress && (
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }}
          ...
          style={{ background: "rgba(43,80,246,0.08)", border: "1px solid rgba(43,80,246,0.2)" }}>
          <DollarSign className="w-4 h-4 flex-shrink-0" style={{ color: "#B9C6FF" }} />
                  ...
                  {unpaidDeliveries.map((d: any, i: number) => (
                    <tr key={i} style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}
                      ...
                      <td className="px-5 py-3.5">
                        <span className="text-xs px-2 py-1 rounded-md font-medium" style={{ background: "rgba(43,80,246,0.15)", color: "#B9C6FF" }}>{d.game || "-"}</span>
                      </td>
