...
const STATUS_STYLES: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  paid:               { bg: "rgba(219,234,254,0.12)", text: "#93c5fd",  dot: "#5A78FF" },
  delivering:         { bg: "rgba(237,233,254,0.12)", text: "#C7D4FF",  dot: "#7c3aed" },
  completed:          { bg: "rgba(209,250,229,0.12)", text: "#6ee7b7",  dot: "#22C55E" },
