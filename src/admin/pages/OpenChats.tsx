  ...
  return (
    ...
    >
      <div className="relative flex-shrink-0 mt-0.5">
        ...
        <span className={cn("absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border-2 border-[#101C48]", cfg.dot, cfg.dotPulse ? "animate-pulse" : "")} />
      </div>
...
function OrderProfilePanel({
  ...
  return (
    <div className="flex flex-col h-full bg-[#101C48] border-l border-white/5 overflow-y-auto w-72 flex-shrink-0">
      {/* Header */}
        ...
        <div className="p-3 border-t border-white/5 flex-shrink-0">
          <div className="flex gap-2 items-end">
            <textarea
              ...
              rows={1}
              className="flex-1 bg-[#131F4D] border border-white/10 text-white placeholder-slate-500 rounded-xl px-4 py-2.5 text-sm resize-none focus:outline-none focus:border-blue-500/50 transition-colors"
...
export default function OpenChats() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      {/* ── Left: Session List ── */}
      <div className={`${showChatMobile ? "hidden" : "flex"} md:flex flex-col w-full md:w-80 flex-shrink-0 border-r border-white/5 bg-[#101C48]`}>
        <div className="px-4 py-4 border-b border-white/5 flex-shrink-0">
      ...
      {/* ── Center: Chat ── */}
      <div className={`${showChatMobile ? "flex" : "hidden"} md:flex flex-1 flex-col overflow-hidden bg-[#0B1437]`}>
        {!selectedSession ? (
