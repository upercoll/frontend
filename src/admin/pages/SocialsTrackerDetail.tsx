  ...
  return (
    <div className="p-6 space-y-5 max-w-[1200px] mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>{creator?.name || "Creator"}</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: "Total Videos", value: allSubmissions.length, icon: Video, color: "#2B50F6" },
          ...
          <div key={i} className="bg-white rounded-xl p-4" style={{ border: "1px solid #E9EBF5" }}>
            ...
            <p className="text-xl font-bold" style={{ color: "#16204D" }}>{s.value}</p>
          </div>
        ))}
      </div>
      ...
      <div className="bg-white rounded-xl overflow-hidden" style={{ border: "1px solid #E9EBF5", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
        <div className="px-5 py-4 flex items-center justify-between" style={{ borderBottom: "1px solid #F3F4F6" }}>
          <h3 className="font-bold text-sm" style={{ color: "#16204D" }}>
              ...
              return (
                <motion.div key={s._id}
                  ...
                  <div className="p-3 space-y-2">
                    <p className="font-semibold text-sm leading-snug line-clamp-2" style={{ color: "#16204D" }}>
                      {s.title || "Untitled"}
                    </p>
      ...
      <div className="bg-white rounded-xl overflow-hidden" style={{ border: "1px solid #E9EBF5", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
        <div className="px-5 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
          <h3 className="font-bold text-sm" style={{ color: "#16204D" }}>Payout History</h3>
        </div>
        {payouts.length === 0 ? (
          <div className="p-12 text-center text-slate-400">
              ...
              {payouts.map((p: any, idx: number) => (
                <tr key={p._id}
                  ...
                  <td className="px-5 py-3.5">
                    <span className="text-sm font-bold" style={{ color: "#16204D" }}>${p.amount.toFixed(2)} USD</span>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        {confirmOpen && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.96, y: 16 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.96, y: 16 }}
              ...
              <h3 className="font-bold text-base mb-2" style={{ color: "#16204D" }}>Confirm Payout</h3>
              ...
              <div className="mb-4 rounded-xl p-4" style={{ background: "#F7F8FC", border: "1px solid #E9EBF5" }}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    style={{ background: "#fff", border: "1px solid #E9EBF5", color: "#16204D" }}
                  />
                </div>
                {isPartial && (
