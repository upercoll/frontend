  ...
  return (
    <div className="p-6 space-y-5 max-w-[1000px] mx-auto">
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-3">
            <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>Payout Detail</h2>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white rounded-xl p-5" style={{ border: "1px solid #E9EBF5" }}>
          ...
          <p className="text-2xl font-bold" style={{ color: "#16204D" }}>${payoutTotal.toFixed(2)} USD</p>
        </div>
        <div className="bg-white rounded-xl p-5" style={{ border: "1px solid #E9EBF5" }}>
          <div className="flex items-center gap-2 mb-2">
            <DollarSign className="w-4 h-4 text-slate-400" />
          ...
          <p className="text-2xl font-bold" style={{ color: "#16204D" }}>${orderTotal.toFixed(2)} USD</p>
        </div>
        <div className="bg-white rounded-xl p-5" style={{ border: "1px solid #E9EBF5" }}>
          <div className="flex items-center gap-2 mb-2">
            <DollarSign className="w-4 h-4 text-slate-400" />
          ...
          <p className="text-2xl font-bold" style={{ color: "#16204D" }}>$0.00 USD</p>
        </div>
      </div>
              ...
              {sales.map((s: any, i: number) => (
                <tr key={i} style={{ borderBottom: "1px solid #F3F4F6" }}
                  ...
                  <td className="px-5 py-3.5">
                    <span className="text-sm font-medium" style={{ color: "#2B50F6" }}>#{s.orderNumber?.replace("RB-", "")}</span>
                  </td>
                  <td className="px-5 py-3.5 text-sm font-medium" style={{ color: "#16204D" }}>{s.productName}</td>
                  <td className="px-5 py-3.5 text-sm text-slate-400">{s.sku || "-"}</td>
                  <td className="px-5 py-3.5 text-sm font-semibold" style={{ color: "#16204D" }}>${s.earnings?.toFixed(2)} USD</td>
                </tr>
              ))}
            </tbody>
          </table>
