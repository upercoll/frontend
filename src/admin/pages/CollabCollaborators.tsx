  ...
  return (
    <div className="p-6 space-y-5 max-w-[1200px] mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>Collaborators</h2>
            ...
            <tbody>
              {collaborators.map((c: any) => (
                ...
                >
                  ...
                  <td className="px-5 py-4">
                    <span className="text-sm font-medium" style={{ color: "#16204D" }}>{c.productCount ?? 0}</span>
                  </td>
                  <td className="px-5 py-4">
                    {c.status === "active"
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.96, y: 16 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.96, y: 16 }}
              ...
              <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
                <h3 className="font-bold text-base" style={{ color: "#16204D" }}>Invite Collaborator</h3>
