  ...
  return (
    <div className="p-6 space-y-5 max-w-[1400px] mx-auto">
      ...
      {activeClaims.length > 0 && (
        <div className="bg-[#131F4D] border border-blue-500/20 rounded-xl overflow-hidden">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <motion.div key={i} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
            className="bg-[#131F4D] border border-white/5 rounded-xl p-4">
      ...
      {isLoading ? (
        <div className="space-y-3">{Array.from({ length: 5 }).map((_, i) => <div key={i} className="h-16 bg-[#131F4D] rounded-xl border border-white/5 animate-pulse" />)}</div>
      ) : agents.length === 0 ? (
        ...
        <div className="bg-[#131F4D] border border-white/5 rounded-xl overflow-hidden">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="relative flex-shrink-0">
                          ...
                          {agent.stats?.isOnline && (
                            <span className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-emerald-400 rounded-full border-2 border-[#131F4D]" />
                          )}
                        </div>
                        <div>
