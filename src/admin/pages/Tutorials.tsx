  ...
  return (
    <div className="p-6 space-y-5 max-w-[1000px] mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>Tutorials</h2>
                ...
                {items.map((t, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold truncate" style={{ color: "#16204D" }}>{t.title}</p>
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <button
                        ...
                        style={{ background: t.active ? "#ECFDF5" : "#F3F4F6", color: t.active ? "#22C55E" : "#9CA3AF" }}
          ...
          >
            ...
            >
              <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
                <h3 className="font-bold text-lg" style={{ color: "#16204D" }}>
