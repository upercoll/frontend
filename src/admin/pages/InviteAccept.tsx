  ...
  return (
    <div className="min-h-screen bg-[#0B1437] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-[#131F4D] border border-white/5 rounded-2xl overflow-hidden shadow-xl">
              ...
              <motion.div key="info" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="p-6 space-y-5">
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 bg-white/3 border border-white/5 rounded-xl p-3">
                      <div className="w-4 h-4 rounded-full flex-shrink-0" style={{ background: inviteData.role?.color || "#2B50F6" }} />
                      <div>
                ...
                <form onSubmit={verifyAndSetup} className="p-6 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      maxLength={6}
                      required
                      className="w-full bg-[#101C48] border border-white/10 text-white text-center text-2xl tracking-[0.5em] placeholder-slate-700 rounded-xl py-3 focus:outline-none focus:border-blue-500/50"
                    />
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <input type={showPass ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password (min 8 chars)" required minLength={8}
                          className="w-full bg-[#101C48] border border-white/10 text-white placeholder-slate-600 rounded-xl px-4 pr-11 py-2.5 text-sm focus:outline-none focus:border-blue-500/50" />
