...
export default function AdminProfilePage() {
  ...
  return (
    <div className="p-6 max-w-[700px] mx-auto space-y-6">
      ...
      <div className="bg-[#131F4D] border border-white/5 rounded-2xl p-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input value={displayName} onChange={(e) => setDisplayName(e.target.value)}
                className="w-full bg-[#101C48] border border-white/10 text-white rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:border-blue-500/50" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea value={bio} onChange={(e) => setBio(e.target.value)} maxLength={200} rows={3}
                className="w-full bg-[#101C48] border border-white/10 text-white rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:border-blue-500/50 resize-none" />
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showCurrent ? "text" : "password"} value={currentPass} onChange={(e) => setCurrentPass(e.target.value)} required
                  className="w-full bg-[#101C48] border border-white/10 text-white rounded-xl pl-10 pr-11 py-2.5 text-sm focus:outline-none focus:border-blue-500/50" />
