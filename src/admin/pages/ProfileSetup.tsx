  ...
  return (
    <div className="min-h-screen bg-[#0B1437] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-[#131F4D] border border-white/5 rounded-2xl p-6 shadow-xl">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input value={displayName} onChange={(e) => setDisplayName(e.target.value)} required placeholder="Your name"
                  className="w-full bg-[#101C48] border border-white/10 text-white placeholder-slate-600 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:border-blue-500/50" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea value={bio} onChange={(e) => setBio(e.target.value)} maxLength={200} placeholder="Tell the team a bit about yourself..." rows={3}
                  className="w-full bg-[#101C48] border border-white/10 text-white placeholder-slate-600 rounded-xl pl-10 pr-4 py-3 text-sm focus:outline-none focus:border-blue-500/50 resize-none" />
              </div>
