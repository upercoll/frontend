  ...
  return (
    ...
    >
      <div className="relative flex-shrink-0 mt-0.5">
        ...
        <span className={cn(
          "absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border-[2px] border-[#101C48]",
                ...
                <div
                  ...
                  style={{
                    background: item.gradient
                      ...
                      : "linear-gradient(135deg, #16204D 0%, #312e81 100%)",
                  }}
                >
                  <div
...
export default function Queue() {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] overflow-hidden bg-[#0B1437]">

      {/* ══════ LEFT: Inbox ══════ */}
      <div className={cn(
        "flex flex-col flex-shrink-0 border-r border-white/5 bg-[#101C48] w-full md:w-72",
      ...
      {mobilePanel === 2 && (
        <button onClick={() => setMobilePanel(1)}
          className="md:hidden fixed top-[72px] left-3 z-30 w-8 h-8 bg-[#101C48] border border-white/10 rounded-lg flex items-center justify-center text-slate-400">
          <ArrowLeft className="w-4 h-4" />
        </button>
      )}
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <input value={estDelivery} onChange={e => setEstDelivery(e.target.value)} placeholder="e.g. 5 minutes"
                    className="w-full bg-[#101C48] border border-white/10 text-white placeholder-slate-600 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-indigo-500/50" />
                </div>
                <div>
                  ...
                  <textarea value={podNotes} onChange={e => setPodNotes(e.target.value)} placeholder="Optional notes…" rows={2}
                    className="w-full bg-[#101C48] border border-white/10 text-white placeholder-slate-600 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-indigo-500/50 resize-none" />
                </div>
              </div>
