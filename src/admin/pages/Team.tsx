  ...
  return (
    <div className="p-6 space-y-5 max-w-[1200px] mx-auto">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-bold" style={{ color: "#16204D" }}>Team Members</h2>
                  ...
                  <div className="relative flex-shrink-0">
                    {member.profile?.profilePicture ? (
                      ...
                      <div className="w-10 h-10 rounded-full flex items-center justify-center"
                        style={{ background: "linear-gradient(135deg,#2B50F6,#2B50F6)" }}>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
                <h3 className="font-bold text-lg" style={{ color: "#16204D" }}>Invite Team Member</h3>
                <button
                  onClick={() => setShowInvite(false)}
                      ...
                      {games.map((g: import("../types").Game) => (
                        <button
                          ...
                          style={inviteGames.includes(g.slug)
                            ? { background: "#EEF2FF", borderColor: "#B9C6FF", color: "#2B50F6" }
